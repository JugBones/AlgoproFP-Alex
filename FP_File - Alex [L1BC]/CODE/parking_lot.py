# Parking Lot Project - Alexander Tjiandra [L1BC]
...
# vehicle class - has a type and license plate number, once created, saves the current time for the next fare calculation
class Vehicle:
...
# space class - stores a vehicle object and current lot status
class Space:
    def __init__(self):
        self.vehicle = None
        self.occupied = False
